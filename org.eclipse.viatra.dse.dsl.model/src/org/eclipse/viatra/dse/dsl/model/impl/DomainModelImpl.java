 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.viatra.dse.dsl.model.impl.DomainModelImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainModelImpl extends MinimalEObjectImpl.Container implements DomainModel {
	...
	protected EClass eStaticClass() {
		return DseexecutionmodelPackage.Literals.DOMAIN_MODEL;
	}
	...
	public EList<Type> getType() {
		if (type == null) {
			type = new EObjectContainmentEList<Type>(Type.class, this, DseexecutionmodelPackage.DOMAIN_MODEL__TYPE);
		}
		return type;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DseexecutionmodelPackage.DOMAIN_MODEL__TYPE:
